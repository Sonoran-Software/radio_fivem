<template>
    <div class="screen">
        ...
        <div class="sc-body">
            <div class="sc-row" v-for="conversation in $store.state.conversations" :key="conversation.sender">
                <div class="sc-row-label" v-on:click="$emit('set-screen', 'message')">{{conversation}}</div>
